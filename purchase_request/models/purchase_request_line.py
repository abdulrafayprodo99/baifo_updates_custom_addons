...
class PurchaseRequestLine(models.Model):
    ...
    available_qty = fields.Float(string='Qty On Hand', related="product_id.qty_available", readonly=True)
    ...
    def _compute_purchase_state(self):
        for rec in self:
            ...
            if rec.purchase_lines:
                ...
                # bilal start
                elif any(po_line.state == "compartive" for po_line in rec.purchase_lines):
                    temp_purchase_state = "compartive"
                elif any(po_line.state == "comparative done" for po_line in rec.purchase_lines):
                    temp_purchase_state = "comparative done"
                # bilal start
                elif all(
