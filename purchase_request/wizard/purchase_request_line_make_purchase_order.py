...
class PurchaseRequestLineMakePurchaseOrder(models.TransientModel):
    ...
    def _prepare_item(self, line):
        # raise UserError("@@@" + " " +str(line.specifications))
        return {
            "line_id": line.id,
    ...
    def _prepare_purchase_order(self, picking_type, group_id, company, origin, request_id):
        ...
        data = {
            ...
            "pr_type": request_id.pr_type if request_id.pr_type else False,
            "opex_type": request_id.opex_type if request_id.opex_type else False,
            "opex_sub_type": request_id.opex_sub_type if request_id.opex_sub_type else False,
            "capex_type": request_id.capex_type if request_id.capex_type else False,
        }
        return data
