...
class AccountJournal(models.Model):
    ...
    sequence_id_2 = fields.Many2one('ir.sequence', string='Customer Payment Sequence',
                                  help="This field contains the information related to the numbering of the"
                                       " journal entries of this journal.",
                                  required=True, copy=False)
    customer_payment_code = fields.Char('Customer Payment Short Code')
    ...
    refund_sequence_id = fields.Many2one('ir.sequence', string='Credit Note Entry Sequence',
                                         ...
                                         copy=False)
    refund_sequence_id_2= fields.Many2one('ir.sequence', string='Customer Payment Credit Note Entry Sequence',
                                         help="This field contains the information related to the "
                                              "numbering of the credit note entries of this journal.",
                                         copy=False)
    ...
    sequence_code_short = fields.Char('Sequence Short Code')

    def update_number_next(self):        
        new_number_next = self.next_seq_number + 1
        double_padded_number_next = str(new_number_next).rjust(5, '0')
