                ...
                for line in account["move_lines"]:
                    ...
                    if line["ref_label"] != "Centralized entries":
                        ...
                        for account_id, value in line["analytic_distribution"].items():
                            if int(account_id) in analytic_data:
                                if value < 100:
                                ...
                                # Handle the case where the account_id is not found in analytic_data
                                analytic_distribution += "Unknown Account %d%% " % value if value < 100 else "Unknown Account "
                        line.update(
                            {
